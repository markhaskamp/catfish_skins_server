...
/***/ function(module, exports, __webpack_require__) {
	...
	var _myscores = __webpack_require__(175);

	var _myscores2 = _interopRequireDefault(_myscores);
	...
	var Login = function (_React$Component) {
	  ...
	  _createClass(Login, [{
	    ...
	    value: function handleClickLogin(e) {
	      ...
	      var url = '/login';
	      var name = (0, _jquery2.default)('#txtName').val();
	      var pwd = (0, _jquery2.default)('#txtPassword').val();
	      var payload = "{\"name\": \"" + name + "\", \"pwd\": \"" + pwd + "\"}";

	      _jquery2.default.ajax({ 'method': 'POST', 'url': url, 'data': payload }).done(function (data) {
	        console.log('data:');
	        console.log(data);
	      }).fail(function (f) {
	        console.log('f:');
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement("input", { id: "txtName" }),
	          ...
	          _react2.default.createElement("input", { id: "txtPassword" }),
	          _react2.default.createElement("br", null),
	          _react2.default.createElement("input", { type: "button", value: "Login", onClick: this.handleClickLogin.bind(this) })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "span.label {\n  width: 75px;\n  display: inline-block;\n}\n\n#login input {\n  margin-left: 1.0em;\n}\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyScores = function (_React$Component) {
	  _inherits(MyScores, _React$Component);

	  function MyScores() {
	    _classCallCheck(this, MyScores);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(MyScores).call(this));
	  }

	  _createClass(MyScores, [{
	    key: "handleChangeHoleScore",
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "1", placeholder: "1", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "2", placeholder: "2", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "3", placeholder: "3", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "4", placeholder: "4", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "5", placeholder: "5", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "6", placeholder: "6", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "7", placeholder: "7", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "8", placeholder: "8", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "9", placeholder: "9", onChange: this.handleChangeHoleScore.bind(this) })
	              )
	            ),
	            _react2.default.createElement(
	              "tr",
	              ...
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "10", placeholder: "10", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "11", placeholder: "11", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "12", placeholder: "12", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "13", placeholder: "13", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "14", placeholder: "14", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "15", placeholder: "15", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "16", placeholder: "16", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "17", placeholder: "17", onChange: this.handleChangeHoleScore.bind(this) })
	              ),
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { id: "18", placeholder: "18", onChange: this.handleChangeHoleScore.bind(this) })
	              )
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./myscores.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./myscores.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
